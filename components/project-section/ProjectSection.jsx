...
const ProjectSection = () => {
  return (
    <>
      <div
        id="projects"
        className="flex justify-center text-xl font-bold mt-24 mb-6 text-color-black"
      >
        Projects
      </div>
      <div className="container mx-auto project-section text-color-black">
        <div className=" lock max-w-lg p-6 bg-white border border-gray-200 rounded-lg shadow-lg">
          <Image
            ...
            alt="Image"
          />
          <h5 className="mb-2 text-base font-bold tracking-tight text-gray-900 my-5">
            Shadhin
          </h5>
          <h5 className="mb-2 text-base font-bold tracking-tight text-gray-900  my-5">
            Type: <span className="font-normal">Professional</span>
          </h5>
          <p className="font-normal text-base text-gray-700  py-4">
            A Bangladeshi audio and video streaming platform over than million
            users globally.
          </p>

          <p className="font-bold text-base text-color-black">
            Technology (Frontend):{' '}
        ...
        <div className=" lock max-w-lg p-6 bg-white border border-gray-200 rounded-lg shadow-lg">
          ...
          <h5 className="mb-2 text-base font-bold tracking-tight text-gray-900 y-5">
            Type: <span className="font-normal">Professional</span>
          </h5>
          <p className="font-normal text-base text-gray-700  py-4">
